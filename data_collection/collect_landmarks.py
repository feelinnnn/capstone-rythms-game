...
TARGET_PER_USER = 1000 # เพิ่มเป้าหมาย 1,000 เฟรมต่อ 1 คน
...
while True:
    ...
    # 1. คำนวณความคืบหน้าและเลือก UI หมวดหมู่ (แบบของซี)
    ...
    if state == "COMPLETE":
        ...
        # --- ลอจิกการประมวลผลและการกรอง (ของฟีลลิ่ง 100%) ---
    ...
    # --- 3. วาด UI บนหน้าจอ (สไตล์โค้ดของซี 100%) ---
    ...
    if cv2.waitKey(1) & 0xFF == 27: # กฎของฟีลลิ่งคือการกดปุ่ม 'Esc' (รหัส 27) เพื่อออก
        break
